    ...
    const eventData = [
      {
        ...
        end_time: new Date(oneWeekLater.getTime() + 4 * 60 * 60 * 1000), // 4小時後
        registration_deadline: new Date(
          oneWeekLater.getTime() - 24 * 60 * 60 * 1000
        ), // 1天前
        place: "台北市信義區松仁路100號 台北101大樓 89樓會議廳",
        max_participants: 50,
        created_by: 1,
        createdAt: now,
        updatedAt: now,
      },
      {
        ...
        start_time: twoWeeksLater,
        end_time: new Date(twoWeeksLater.getTime() + 3 * 60 * 60 * 1000), // 3小時後
        registration_deadline: new Date(
      ...
      },
      {
        ...
        start_time: threeWeeksLater,
        end_time: new Date(threeWeeksLater.getTime() + 6 * 60 * 60 * 1000), // 6小時後
        registration_deadline: new Date(
          threeWeeksLater.getTime() - 3 * 24 * 60 * 60 * 1000
        ), // 3天前
        place: "台北市中山區南京東路二段125號 台北市立美術館 多媒體會議室",
        max_participants: 25,
        created_by: 3,
        createdAt: now,
        updatedAt: now,
